  ...
  if ($(window).width() > 991) {
    $('#toggle-side-menu').click(function(){
      ...
      if ($('.aside').hasClass("hide-menu")) {
        ...
        $('.dommus-wrapper .dommus-content').css('width', 'calc(100vw - 60px - 22px)');
      }else {
        $('.aside').find('h4, p').slideToggle(200);
        $('.dommus-wrapper .dommus-content').css('width', 'calc(100vw - 250px - 22px)');
      }
    ...
    $('#unidade').change(function(){
      if ($(this).val() != '0') {
        $('.processo-section-3').slideDown('slow');
      ...
      var valor_fgts = parseFloat($("#valor-fgts").text());
      var valor_subsidio = parseFloat($("#valor-subsidio").text());
      var valor_financiamento = parseFloat($("#valor-financiamento").text());
      var valor_custas = parseFloat($("#valor-custas").text());
      var valor_prosoluto = valor_unidade - valor_fgts - valor_subsidio - valor_financiamento + valor_custas ;
    ...
    $('#btn-distribuir').on( 'click', function (e) {
      ...
      var entrou = true;
        ...
        if (entrou) {
          ...
          var btn_acoes = '<div class="dropdown show acoes"><a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-pencil" aria-hidden="true"></i></a>'+
          ...
          var button_exclude =  '<button class="table-remove btn btn-danger btn-rounded btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></button>';
          var button_edit = '<button class="table-edit btn btn-primary btn-rounded btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i></button>';
        ...
        $('.table-edit').click(function(){
          ...
          alert('parcela ant: ' + parcela_anterior);
          alert('valor ant: ' + valor_anterior);
          ...
          alert('vlr parc: ' + $(editar_tr + ' td.valor-parcela').text());
          alert('qtde parc: ' + $(editar_tr + ' td.quantidade-parcela').text());
          alert('dt venc:' + $(editar_tr + ' td.data-vencimento').text());
    ...
    $("#valor-parcela, #valor-parcela-modal").maskMoney({
         // prefix: "R$",
         decimal: ",",
         thousands:  ''
     });
